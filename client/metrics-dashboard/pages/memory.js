 ...
 * memoryView
 *
 * Sends Websocket request when this page is loaded for ram data. When request is received, it populates the apex chart
 * in the HTML return statement and then displays the content on the screen.
 *
 * Return: HTML that contains a label for the RAM page and the RAM chart
 */
const memoryView = props => {
  //variables to set and store the incoming RAM data
  ...
  const socketInitializer = async () => {
    //make connection to websocket server and immediately send request for ram data
    socket.onopen = () => {
